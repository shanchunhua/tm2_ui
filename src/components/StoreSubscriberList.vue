  ...
  <div class="weui_cells" infinite-scroll="ownerCtrl.loadMoreRelation()">
    <div class="weui_cell" v-for="o in list">
      ...
      <div class="weui_cell_bd" style="flex: 1;">
        ...
        <p class="gray">
          <span style="display: inline-block;">推荐人:{{o.parent.nickname}}</span>
...
export default {
  ...
  methods: {
    load() {
      const self = this
      this.$http.get(constants.serviceUrl + '/stores/users/SUBSCRIBER').then(function(res) {
